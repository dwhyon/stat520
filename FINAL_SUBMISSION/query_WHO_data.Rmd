...
[BMI among children](https://www.who.int/data/gho/data/themes/topics/indicator-groups/indicator-group-details/GHO/bmi-among-children)
[BMI among adults](https://www.who.int/data/gho/data/themes/topics/indicator-groups/indicator-group-details/GHO/bmi-among-adults)
```{r}
...
# Write to a CSV
write.csv(numeric_data, file="data/interim/WHO_data.csv", row.names = FALSE)
```
